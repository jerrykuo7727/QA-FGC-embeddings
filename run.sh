...
save_path=./models/roberta-1.7.2-woASR-wDROP-datedur_num_mask
...
if [ $stage -le 1 ]; then
  ...
  for split in train dev test; do
    for dir in passage passage_no_unk datedur_mask num_mask question question_no_unk answer span; do
